...
export default function GDash({ onBack }: { onBack?: () => void }) {
    ...
    <div className="min-h-screen bg-[#1a1c23] flex flex-col animate-in fade-in duration-500 font-sans text-slate-200">
      ...
      <header className="bg-[#242731] border-b border-slate-800 px-6 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-xl font-bold text-white">GDash - Todos os Gráficos</h1>
        </div>
        ...
        <div className="space-y-10 max-w-7xl mx-auto pb-20">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-6 border-b border-slate-800 pb-2">
              ...
              <h2 className="text-2xl font-bold text-white">Resultados Gerais</h2>
            </div>
          ...
          <div>
            <div className="flex items-center space-x-2 mb-6 border-b border-slate-800 pb-2">
              <Megaphone className="text-fuchsia-500" size={24} />
              <h2 className="text-2xl font-bold text-white">Mídia Paga</h2>
            </div>
